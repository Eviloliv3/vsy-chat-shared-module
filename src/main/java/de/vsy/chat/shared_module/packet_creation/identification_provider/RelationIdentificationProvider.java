...
import de.vsy.chat.shared_transmission.packet.property.packet_identifier.RelationIdentifier;

import static de.vsy.chat.shared_transmission.packet.property.packet_type.RelationType.CONTACT_RELATION;

public
class RelationIdentificationProvider extends AbstractIdentificationProvider {
