...
import static de.vsy.chat.shared_module.packet_transmission.acknowledgement.AcknowledgementPacketCreator.createAcknowledgement;
...
class PacketReadThread extends ThreadContextRunnable {
    ...
    void processIncomingPacket (final Packet input) {
        ...
        if (input.getPacketContent() != null) {
            final var confirmationPacket = createAcknowledgement(input);
