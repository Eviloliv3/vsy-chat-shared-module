...
public interface ErrorResponseCreator {
  ...
  /**
   * Creates Error response Packet using the thrown PacketHandlingException and the source Packet.
   * If no response Packet can be created, at least a log message should be created.
   *
