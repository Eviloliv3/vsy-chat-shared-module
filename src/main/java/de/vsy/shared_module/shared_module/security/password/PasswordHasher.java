package de.vsy.shared_module.shared_module.security.password;
...
class PasswordHasher {
    ...
    /**
     * Berechnet einen Hashwert für das ubergebene Passwort, mittels der intern
     * vorgegebenen Hashfunktion. Der Hashwert wird in Hexadezimaldarstellung als
     * String ausgegeben.
     *
     ...
     *
     * @throws NullPointerException wenn kein Passwort Charakterarray übergeben
     *                              wurde
     */
    public static
    String calculateHash (char[] passwordChars) {
    ...
    /**
     * Hilfsfunktion! Berechnet den Hashwert für die aktuell im this.passwordDigester
     * eingetragenen Werte. Dann wird das erhaltenen Bytearray in einen
     * vorzeichenbehafteten BigInteger-Wert umgewandelt. Abschließend wird der Wert
     * zur Basis 16 als String erstellt und, nach der Umwandlung aller Buchstaben zu
     * Grossbuchstaben, ausgegeben.
     *
     * @return der Hashwert in Hexadezimaldarstellung
     */
    private static
    String getHexString (MessageDigest digester) {
     ...
     * Hashwertberechners. Der Hashwert wird in Hexadezimaldarstellung als String
     * ausgegeben.
     *
     * @param passwordChars das zu hashende Passwort (char [])
     ...
     */
    public static
    String calculateHash (char[] passwordChars, MessageDigest digester) {
    ...
    /**
     * Berechnet einen Hashwert aus dem ubergebene Passworthashwert und einem
     * übergebenen Salz, mittels der intern vorgegebenen Hashfunktion. Der Hashwert
     * wird in Hexadezimaldarstellung als String ausgegeben.
     *
     ...
     */
    public
    String calculateSaltedHash (byte[] hashedPassword, byte[] salt,
