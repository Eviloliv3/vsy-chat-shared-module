...
/**
 * Enthaelt exklusiv Paketinhalt oder Fehlernachricht sowie ein Flag, das den jeweiligen Inhalt
 * signalisiert. Bei fehlender Fehlernachricht wird eine Standardnachricht ausgegeben.
 *
 * @param <T> Implementierung von PacketContent
 */
public class ContentValidationResult<T extends PacketContent> {
   ...
   *
   * @param validatedContent !null - setze(geprueften Inhalt true); null - setze(
   *                         (Standard-/)Fehlernachricht & false)
   */
  public void setValidatedContent(T validatedContent) {
  ...
  /**
   * Setzt die Fehlernachricht. Inhaltsflag entsprechend gesetzt. Gesetzter Paketinhalt wird
   * geloescht.
   *
   * @param errorMessage !null - setze(Nachricht & !Paketinhalt & false); null - Paketinhalt ?
   *                     setze(Keine Nachricht & true) : setze(Standardnachricht & false)
   */
