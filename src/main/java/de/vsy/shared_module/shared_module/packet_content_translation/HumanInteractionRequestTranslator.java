...
public class HumanInteractionRequestTranslator {

  private static final Map<Class<? extends Translatable>, PacketContentTranslator> translators;

  static {
    translators = new HashMap<>();
    translators.put(ContactRelationRequestDTO.class, new ContactRelationRequestTranslator());
    translators.put(ContactRelationResponseDTO.class, new ContactRelationResponseTranslator());
    translators.put(ErrorDTO.class, null);
  }

  private HumanInteractionRequestTranslator() {
  }
