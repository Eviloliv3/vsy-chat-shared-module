...
public class ContactRelationResponseTranslator extends PacketContentTranslatorBase {

  public String translate(ContactRelationResponseDTO relationDTO) {
    ...
    if (contactData != null) {
      ...
      if (requestData.getDesiredState() && !relationDTO.getDecision()) {
        ...
        friendshipResponse.append("Sie sind jetzt mit ").append(contactName).append(" befreundet");
      }
    } else {
